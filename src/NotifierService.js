...
export class NotifierService {
  ...
  async add(receiverId, socket) {
    ...
    const data = await this.jobHubConnectionsRepository.createNewConnection(
      receiverId
    );
  ...
  async send(receiverId, message) {
    ...
    const data = await this.jobHubConnectionsRepository.getConnectionByUserId(
      receiverId
    );
  ...
  async remove(id) {
    ...
    await this.jobHubConnectionsRepository.deleteConnection(id);
  }
